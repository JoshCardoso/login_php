...
<body>
  <div class="w-full h-screen flex flex-col justify-center items-center dark:bg-black">
    ...
    <div class="border-2 border-gray-400 w-[400px] h-[575px] rounded-2xl py-8 px-10">
      <div>
        ...
        <h3 class="flex text-xl font-bold mt-6 dark:text-white">Join thousands of learners from around the world</h3>
        <p class="my-4 dark:text-white">Master web development by making real-life projects. There are multiple paths for you to choose</p>
        <form action="/src/handle_db/save_user.php" method="post">
          ...
          <button type="submit" class="w-full bg-blue-600 active:bg-white text-white active:text-blue-600  p-2 rounded-xl border border-blue-600">Start coding now </button>
        </form>
        <div class="flex justify-center items-center flex-col m-6">
          ...
          <p class="text-sm text-gray-600">Adready a member?<a href="./views/login.php" class="text-blue-600">Login</a></p>
        </div>
      </div>
    </div>
  </div>
